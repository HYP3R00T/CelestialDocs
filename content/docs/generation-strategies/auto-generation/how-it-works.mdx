...
See [Hybrid Approach](/new-docs/generation-strategies/hybrid-approach/best-of-both) for details.
...
- [Hybrid Approach](/new-docs/generation-strategies/hybrid-approach/best-of-both)
- [Configuration Examples](/new-docs/configuration/basics/sidebar-structure)
