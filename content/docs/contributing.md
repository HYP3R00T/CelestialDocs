...
- [ ] If relevant, `navLabel` or `navIcon` frontmatter is set to control sidebar presentation. If `navLabel` is present in the page frontmatter it takes precedence over labels configured in `data/config.ts`.
