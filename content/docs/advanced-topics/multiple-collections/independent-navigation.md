...
Learn about:
- [Multiple Collections Setup](/new-docs/advanced-topics/multiple-collections/setup)
- [Real-World Use Cases](/new-docs/advanced-topics/multiple-collections/use-cases)
