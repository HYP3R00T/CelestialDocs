    ...
    "new-docs": {
        ...
        groups: [
            ...
            },
            {
                id: "advanced",
                label: "Advanced",
                groups: [  // ← Another single-level nesting
...
Files added to `content/new-docs/guides/getting-started/` appear automatically under "Getting Started" subgroup.

Files added to `content/new-docs/guides/advanced-tasks/` appear automatically under "Advanced Tasks" subgroup.
...
- [Nested Groups Best Practices](/new-docs/configuration/advanced/nested-setup/best-practices)
- [Nested Groups Deep Dive](/new-docs/navigation-system/hierarchy/real-world-examples)
