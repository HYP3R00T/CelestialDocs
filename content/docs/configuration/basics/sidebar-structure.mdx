...
export const SIDEBAR_NAVIGATION: SidebarNavigation = {
    ...
    docs: {
        ...
        groups: [ /* docs structure */ ],
    },
    // Collection 2: api
    api: {
        defaultTab: { label: "API", icon: "📡" },
        groups: [ /* api structure */ ],
    },
    // Collection 3: guides
    guides: {
        defaultTab: { label: "Tutorials", icon: "🎓" },
        groups: [ /* guides structure */ ],
    },
};
```
...
- [Auto-Generation](/new-docs/generation-strategies/auto-generation/how-it-works)
- [Manual Creation](/new-docs/generation-strategies/manual-creation/explicit-control)
- [Nested Setup](/new-docs/configuration/advanced/nested-setup/single-level)
