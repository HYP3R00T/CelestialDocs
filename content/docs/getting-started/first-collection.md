...
Navigate to `http://localhost:3000/my-docs/guides/hello`
...
- Learn about [Groups and Entries](/new-docs/navigation-system/core-concepts/entries)
- Explore [Navigation Configuration](/new-docs/configuration/basics/sidebar-structure)
