...
To change the order, see [Manual Configuration](/new-docs/generation-strategies/manual-creation/explicit-control).
...
Learn about:
- [Understanding Entries](/new-docs/navigation-system/core-concepts/entries)
- [Auto-Generation vs Manual](/new-docs/generation-strategies/auto-generation/how-it-works)
- [Advanced Frontmatter](/new-docs/content/frontmatter/navigation-overrides)
