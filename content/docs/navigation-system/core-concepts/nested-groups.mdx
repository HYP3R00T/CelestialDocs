...
Learn about:
- [Tabs](/new-docs/navigation-system/core-concepts/tabs) - Promote groups to tabs
- [Configuration Guide](/new-docs/configuration/advanced/nested-setup/single-level)
