...
description: "Create a custom home page for your documentation site."
navLabel: "Custom Landing"
navIcon: "🏠"
draft: false
---

The landing page (home page) can be customized to your brand and content.

## Default Landing

By default, visiting the root `/` redirects to your first documentation collection (usually `/docs`).
